...
| 5. Agentic knowledge | Named bases, meeting assignment, private/org/specific sharing, saved chats, selectable text model, source-linked Q&A | Canonical records plus manually refreshed, organization-scoped hybrid index are built; background indexing, query planning, linked topic pages and retention remain | Source-linked hybrid workflow built; deeper agent planned |
